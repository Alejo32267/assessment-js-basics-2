...
const pizza = {
  ...
  tags: ["gluten-free", "family-friendly", "meat"]
};
...
const hasTag = (food, tag) => {
  return food.tags.includes(tag);
};

const filteredFood = foodArr.filter((food) => hasTag(food, 'vegetarian'));
...
// Invoke the filterByProperty function and log the filtered array
